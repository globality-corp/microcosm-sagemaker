    ...
    def setup(self):
        self.graph = create_object_graph(
            ...
            loader=load_from_dict(
                dict(
                    active_bundle="compound_bundle_with_metric",
                )
            ),
            testing=False,
        )
        self.graph.use("training_initializers", "wandb", "simple_bundle_with_metric", "compound_bundle_with_metric")
        self.graph.lock()
        ...
        with patch("wandb.init") as wandb_init:
            ...
            assert_that(
                ...
                has_entries(
                    ...
                    config=is_(equal_to(
                        dict(
                            compound_bundle_with_metric=dict(
                                param1=3,
                                param2=4,
                            ),
