...
class SimpleBundle(Bundle):
    ...
    def fit(self, input_data: InputData) -> None:
        ...
        For this simple, we just expect the input dataset to contain a file
    ...
    def save(self, output_artifact: OutputArtifact) -> None:
        ...
        For this simple, we just store the param we read during training.
    ...
    def load(self, input_artifact: InputArtifact) -> None:
        ...
        For this simple, we just load the param we stored during save.
    ...
    def predict(self, simple_arg: float) -> List[SimplePrediction]:
        ...
        For this simple, we just add the configured param, the learned param,
